...
class Group(models.Model):
    ...
    course_id=models.ForeignKey(Subjects,on_delete=models.DO_NOTHING,blank=True,null=True)
    staff_id=models.ForeignKey(Staffs,on_delete=models.DO_NOTHING,blank=True,null=True,related_name="groups")
...
class Students(models.Model):
    ...
    course_id=models.ForeignKey(Subjects,on_delete=models.DO_NOTHING,blank=True,null=True)
    group_id=models.ForeignKey(Group,on_delete=models.DO_NOTHING,blank=True,null=True,related_name="students")
    parent = models.ForeignKey(CustomUser,on_delete=models.DO_NOTHING,blank=True,null=True,related_name="students")
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now_add=True)
    objects = models.Manager()
